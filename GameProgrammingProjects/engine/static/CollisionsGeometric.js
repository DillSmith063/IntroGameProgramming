class CollisionsGeometric {
    ...
    static isVector2Rectangle2Collision(one, two){
        if(
    ...
    static isVector2Circle2Collision(one, two){
    ...
    static isCircle2Line2Collision(one, two){
    ...
    static isCircle2Rectangle2Collision(one, two){
